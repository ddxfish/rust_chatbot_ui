...
impl ChatbotUi {
    ...
    pub fn render(&mut self, ui: &mut Ui, chat: &mut Chat, settings: &mut Settings, icons: &Icons, providers: &[Arc<dyn ProviderTrait + Send + Sync>], theme: &Theme, _current_profile: &mut ProfileType, _app_state: &mut ChatbotAppState) {
